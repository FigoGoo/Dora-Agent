...
func ValidateGenerationCostDisclosurePayload(payload GenerationCostDisclosurePayload) error {
	...
	if err := foundation.ValidateDigest(payload.ToolPlanDigest); err != nil {
	...
	if payload.SkillUsageStatus != nil && !foundation.IsValidState(foundation.StateSkillUsageStatus, *payload.SkillUsageStatus) {
...
func ValidateToolTaskUpdatedPayload(payload ToolTaskUpdatedPayload) error {
	...
	if !foundation.IsValidState(foundation.StateToolTaskStatus, payload.Status) {
