...
6. Agent 流式输出 UI：支持 message.started、message.delta、message.completed 的增量渲染。
7. Tool 调用 UI：展示 tool.call、tool.result、耗时、状态和错误。
8. 人工确认 UI：展示 interrupt.required，支持确认、拒绝、修改后继续。
