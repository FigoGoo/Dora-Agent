...
| W2-R01 | [`graph-tool-result-receipt-contract-v1.md`](../design/agent/graph-tool-result-receipt-contract-v1.md)、[`runner-session-lane-review-v1.md`](../design/agent/runner-session-lane-review-v1.md) 与 [`aigc-contract-catalog.md`](../design/cross-module/aigc-contract-catalog.md) | Agent-owned Review Ready，仍未 Approved；8 个合法 Result、40 个 Result 拒绝、24 个 Receipt 迁移和 13 个跨状态 evidence 向量已由 Agent `GOWORK=off` 契约测试消费，覆盖 Unicode/UUID、JS safe integer、跨层/同层稳定错误优先级、pinned slot/ref/effect-class 绑定、精确 Fence/CAS，以及 waiting/completed/partial/failed/两种 cancelled evidence；未创建生产 DTO/Repository/Migration | Agent/Business/安全/运维/财务审核 Corpus、摘要域、slot/CAS 与持久化边界；各 Tool canonical request fixture、跨 Module exact-version 例外及 W2-R08 `card_id` 方案仍需冻结，跨 Module 目录整体 Approved 后才关闭 R01 |
| W2-R02/R03 | [`runner-session-lane-review-v1.md`](../design/agent/runner-session-lane-review-v1.md)、[`session-lane-runtime-contract-v1.md`](../design/agent/session-lane-runtime-contract-v1.md)、[`session-lane-ingress-command-contract-v1.md`](../design/agent/session-lane-ingress-command-contract-v1.md)、[`session-lane-postgresql-design-v1.md`](../design/agent/session-lane-postgresql-design-v1.md)、[`session-lane-legacy-upgrade-contract-v1.md`](../design/agent/session-lane-legacy-upgrade-contract-v1.md)、[`session-event-foundation-marker-v1.md`](../design/agent/session-event-foundation-marker-v1.md)、[`immutable-turn-context-design-v1.md`](../design/agent/immutable-turn-context-design-v1.md)、[`immutable-turn-context-decision-review-v1.md`](../design/agent/immutable-turn-context-decision-review-v1.md)、[`approval-continuation-cross-object-evidence-v1.md`](../design/agent/approval-continuation-cross-object-evidence-v1.md) 与 [`aigc-contract-catalog.md`](../design/cross-module/aigc-contract-catalog.md) | R02 已形成 Agent-owned Executable Draft：60 条 Lane、42 条 Ingress、17 条 legacy Authority、90 条 upgrade blocker、19 条 Marker（含 3 个合法 golden），以及 Message Set/Turn Context 联合 8 个 fixture、70 条向量和 27 个目标测试已固定；后者覆盖 Message Set full-array、58 字段 Turn Context golden、User→Assistant ToolCall→Tool Result→Assistant、六 Tool key/Receipt 因果、256 上限、cutoff 隔离、逐字段 sensitivity 与失败关闭。R03 另以 1 个 fixture、20 条跨对象向量和 13 个目标测试逐值绑定 frozen Receipt、Approval、approve Decision/SourceID、Graph Tool Pin 与完整 Turn Context。10 项 P0 已由机器 manifest 固定为 `awaiting_owner_approval`，独立 Marker/Turn Context/R03 跨对象证据均未 Approved。真实 PostgreSQL 16 已在精确 Migration 005 上逐值通过 V1/V2/Unicode empty 三类 Foundation cohort，并纳入 required-mode，因此状态推进为 `REAL PG PRECONDITION READY`；但 child Receipt/Consumption/Business `Decide*`、forward Migration/Helper/Verify/Down、Receipt/Message/Event 不可变、生产 Runtime、Keyring/Redis/lost-wake/Drain/SMK Evidence 仍不存在 | 先联合审批 Turn Context 10 项 P0、独立 Marker/Retention、Receipt/Message/Event 不可变 DDL、升级 Ledger、Approval/Consumption 和 Claim/Fence/Effect Evidence；期间只继续独立 test-only Corpus；再实现 forward PG Migration/Repository/Helper 与真实 upgrade/race/crash/Down matrix；全部真实 PG 证据批准后才接 Lane Capability Readiness、Eino Runner/Checkpoint、Redis/Scanner/Drain；SMK-018 Worker 主体留在 W3 |
...
| W2-R04 | [`plan_creation_spec-design.md`](../design/agent/graphtool/plan_creation_spec-design.md) 与 [`plan_creation_spec-w2-r04-gap-review.md`](../design/agent/graphtool/plan_creation_spec-w2-r04-gap-review.md) | Draft；独立文档、Mermaid、Node 与分离状态机骨架已齐，但审计确认 Intent/Candidate、逐模型计费、收益归因、Business RPC、typed fan-in/Output 与 A2UI 等十类 P0 | 先关闭共享 R01/R02/R03/R08，再逐项关闭 P0 并重画计费/恢复拓扑 |
