...
| W2-R04 | [`plan_creation_spec-design.md`](../design/agent/graphtool/plan_creation_spec-design.md)、[`plan_creation_spec-w2-r04-gap-review.md`](../design/agent/graphtool/plan_creation_spec-w2-r04-gap-review.md)、[`approval-consumption-receipt-contract-v1.md`](../design/agent/approval-consumption-receipt-contract-v1.md) 与 [`continuation-child-tool-receipt-contract-v1.md`](../design/agent/continuation-child-tool-receipt-contract-v1.md) | Draft；`creation_spec_activation` Consumption unsigned core 已有 102 条 test-only 向量，共享 failed-after/outcome-aware R01 增量已有 11 条向量；child root/parent/双 guard/prepared/unknown 已形成 172 条独立 test-only Corpus 并实际执行 R04/R01 bridge。Intent/Candidate、成功 ResultCode/资源投影、逐模型计费、收益归因、生产 slot ordinal、Business RPC、typed fan-in/Output、A2UI 等 P0 仍未关闭 | 联合评审 child 与共享 R01/R02/R03/R08 证据，冻结成功 ResultCode、生产 slot Registry 和 Business Decide/Query 公共契约；再逐项关闭 Tool P0 并重画计费/恢复拓扑，Owner Approved 前不实现 Graph |
