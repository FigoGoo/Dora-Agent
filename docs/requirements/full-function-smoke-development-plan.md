...
| W2-R04 | [`plan_creation_spec-design.md`](../design/agent/graphtool/plan_creation_spec-design.md)、[`plan_creation_spec-w2-r04-gap-review.md`](../design/agent/graphtool/plan_creation_spec-w2-r04-gap-review.md)、[`approval-consumption-receipt-contract-v1.md`](../design/agent/approval-consumption-receipt-contract-v1.md) 与 [`continuation-child-tool-receipt-contract-v1.md`](../design/agent/continuation-child-tool-receipt-contract-v1.md) | Draft；`creation_spec_activation` Consumption unsigned core 已有 111 条 test-only 向量，child root/parent/双 guard/prepared/unknown 形成 Design Draft，但 child 与 failed-after Corpus pending；Intent/Candidate、逐模型计费、收益归因、Business RPC、typed fan-in/Output、A2UI 等 P0 仍未关闭 | 先补 R01 failed-after 与 child Corpus，继续关闭共享 R01/R02/R03/R08；再逐项关闭 Tool P0 并重画计费/恢复拓扑，Owner Approved 前不实现 Graph |
