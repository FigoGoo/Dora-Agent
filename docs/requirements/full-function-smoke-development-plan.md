...
| W2-R02/R03 | [`runner-session-lane-review-v1.md`](../design/agent/runner-session-lane-review-v1.md) 与 [`aigc-contract-catalog.md`](../design/cross-module/aigc-contract-catalog.md) | Draft；HOL/Lease/Fence、Approval Continuation 与 Checkpoint 候选语义已齐，仍无生产 Runtime | 逐项关闭 Session Lane/Turn/Run、Approval/Consumption、恢复和跨角色复选项 |
