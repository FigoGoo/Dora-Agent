...
更新时间：2026-07-01  
适用范围：PR-4 字段级契约在 Go 运行时的 Skill 发布、市场上架、安装升级、SkillUsageRecord、结算、退款、数据隔离、Business repository、应用层、用户端 Marketplace HTTP 主路径和真实 Marketplace RPC adapter 实现
相关代码路径：`internal/contracts/pr4/**`、`services/business/internal/application/marketplace/**`、`services/business/internal/infra/repository/businesscore/**`、`services/business/internal/transport/http/**`、`services/business/internal/transport/rpc/**`、`kitex_gen/dora/api/businessskillmarketplace/**`
