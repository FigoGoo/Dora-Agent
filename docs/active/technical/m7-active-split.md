...
| PR-5 Done | E2E fixtures、fake provider、release gate、rollback gate、本地 service-level PostgreSQL E2E、Agent HTTP router + Redis container E2E、Agent / Business 独立进程 HTTP smoke 完成；真实浏览器、前端联动和完整测试环境 HTTP 服务 E2E 待 CI / 测试环境 gate |
