...
| PR-5 | `python3 tests/contract/validate_pr5_e2e_gates.py`、`go test ./services/business/internal/e2e/pr5`、`go test ./services/agent/internal/e2e/pr5`、`make pr5-browser-smoke` | fake provider、E2E fixture、release/rollback gate、本地 service-level PostgreSQL E2E、Agent HTTP router + Redis container E2E、Agent / Business 独立进程 HTTP smoke、本地真实浏览器前端联动 smoke 通过 |
