...
M1 Creative Guide / ChatModel Router 基础业务闭环已实现：显式 run_intent 入口支持 entry_guide、capability_question、normal、select_skill；仅写 Agent Runtime 数据与 AG-UI 事件，不触发 Tool、积分、Board/Graph 生成
