...
| Agent DB | `db/migrations/iterations/**/agent/**` | Board、GraphPlan、Snapshot 扩展 |
| Business DB | `db/migrations/iterations/**/business/**` | Marketplace、pricing、usage、settlement 表 |
