...
| 未登录访客 | 无登录态 | 免登录查看精选作品 | 浏览公开分享作品 |

说明：产品层面只有平台管理员和普通用户两类顶层用户。企业拥有者和企业成员是普通用户在企业空间内的角色。未登录访客不是账户体系中的第三类用户，只代表精选作品中心的匿名浏览状态。
...
| 精选作品中心 | 免登录查看分享作品、点赞、分享、标签、分类 | 未登录访客、普通用户 | P0 | [12](./12-作品中心与精选作品PRD.md) |
...
| 公开页面 | 精选作品中心、精选作品详情 | 支持免登录查看分享后的作品 |
...
- 当前文档未 Done 前，不能作为正式开发依据。
- 后续 UI 视觉和设计系统在产品功能确认后再落地。

## 验收标准

- [ ] 已列出第一版完整模块和功能点。
- [ ] 已明确顶层用户、企业角色和平台管理员范围。
- [ ] 已明确统一 Agent、业务微服务、前端和平台后台边界。
- [ ] 已明确当前空间、积分、资产、Skill、Tool、模型之间的核心关系。
- [ ] 已明确第一版非目标。
- [ ] 已提供可用于后续模块 PRD、契约和开发计划的功能大纲。
