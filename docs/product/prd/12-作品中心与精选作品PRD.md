...
owner：产品体验设计师
更新时间：2026-06-25
适用范围：个人作品中心、作品分享、首页公开作品、精选作品中心、点赞、分享、作品标签、作品分类和免登录查看
product_status：Done
...
用户通过统一 Agent 生成音乐、图片、视频等资产后，需要有一个面向个人展示和管理的作品集。作品集中的作品可以被用户主动分享。分享后的作品进入精选作品中心，也可以作为首页公开作品露出，支持免登录查看、作品分类、标签、点赞和分享。
...
- 支持作品分享和取消分享。
- 分享后的作品进入精选作品中心，并可被首页公开作品区引用展示。
- 首页公开作品、精选作品中心和精选作品详情支持免登录查看。
- 精选作品支持点赞、复制分享链接、分类筛选和标签筛选。
- 需要登录的动作由登录弹窗承接，例如点赞、开始创作、创建作品和进入个人中心。
...
| 未登录访客 | 无账户登录态 | 免登录查看首页公开作品、精选作品列表和公开作品详情 |
| 平台管理员 | 平台后台操作 | 必要时下架公开作品并审计 |

说明：未登录访客不是账户体系中的第三类用户，只是匿名浏览状态。产品账户体系仍保持平台管理员和普通用户两类顶层用户；访客不产生用户空间、项目、会话、资产、积分或通知。
...
- 作为未登录访客，我希望打开首页或精选作品链接后可以直接查看公开作品详情。
- 作为未登录访客，我点击点赞、开始创作、创建作品等需要登录的动作时，希望看到登录弹窗，而不是直接丢失当前页面上下文。
...
| 首页公开作品 | 首页展示与用户无关的公开作品摘要 | 未登录访客、登录用户 | P0 |
...
| 精选作品 | 用户主动分享后的公开作品 |
| 首页公开作品 | 首页中展示的公开作品摘要，只来自 Shared 状态公开快照 |
...
- 媒体预览使用公开快照媒体前缀下的 TOS 公共 URL，不直接返回源业务资产 object key。
...
- 首页公开作品和精选作品中心免登录可查看 Shared 状态作品。
- 点赞需要登录，一个登录用户对同一作品只能点赞一次。
- 分享链接免登录可访问 Shared 状态作品详情。
- 取消分享后作品不再出现在精选作品中心，公开链接不可访问。
- 未登录访客触发点赞、开始创作、创建作品、查看个人作品中心、查看资产库、查看积分和通知等需要登录的动作时，前端弹出登录弹窗，并保留当前页面和动作意图。
...
- 首页公开作品、精选作品列表和公开详情只能使用公开快照字段，不得读取用户私有作品详情或资产权限。
- 作品取消分享不删除源资产。
...
| 未登录触发登录动作 | 访客点击点赞、开始创作、创建作品或查看个人数据入口 | 登录后继续 | 弹出登录弹窗并保留当前意图 |
| 未登录点赞 | 访客点击点赞 | 登录后可点赞 | 弹出登录弹窗 |
...
- 公开内容“免登录查看”只包含首页公开作品摘要、精选作品列表、公开作品详情和复制分享链接。
- 点赞需要登录，主要用于去重和防刷。
- 登录弹窗不是独立页面跳转；除用户主动选择注册或完整登录页外，不应丢失当前公开内容浏览上下文。
...
- [ ] 未登录访客可以复制分享链接。
- [ ] 未登录访客触发需要登录的动作时弹出登录弹窗，并在登录后保留原动作意图。
