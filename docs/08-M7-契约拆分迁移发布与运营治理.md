...
相关代码路径：`docs/product/**`、`docs/technical/**`、`docs/contracts/**`、`api/**`、`db/migrations/**`、`services/agent/**`、`services/business/**`、`frontend/**`、`admin_frontend/**`、`tests/**`  
...
| Review 来源 | Active 目标 | 内容 |
| --- | --- | --- |
| `00` | `docs/technical/architecture/**` | 微服务边界、阶段依赖、总体验收 |
| `01-M0` | `docs/contracts/**`、`api/**`、`db/migrations/**` | RPC/API/AG-UI/schema/SQL/状态枚举 |
| `02-M1` | `docs/technical/backend/features/router/**` | Guide、Router、Guard、Eval |
| `03-M2` | `docs/contracts/data/**`、`docs/technical/frontend/features/board/**` | Board、Element、Patch、Replay |
| `04-M3` | `docs/technical/backend/features/eino-graph/**` | Skill Runtime、GraphPlan、Interrupt、Eino Adapter |
| `05-M4` | `docs/technical/backend/features/tool-runtime/**` | ToolPlan、Credit、Asset、Redis Queue |
| `06-M5` | `docs/product/prd/**`、`docs/contracts/rpc/**` | Marketplace、Usage、Settlement、Governance |
| `07-M6` | `docs/test/**`、`docs/technical/frontend/**` | E2E、前后台验收、性能并发 |
| `09/10` | `docs/contracts/**`、`docs/technical/backend/features/**` | Skill 分层、Tool/Model、市场风控和数据隔离 |
