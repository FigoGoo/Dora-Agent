...
var commonColumnBusinessTables = []string{
	...
	"recharge_packages", "recharge_orders", "mock_payment_transactions",
	"billing_package_skus", "package_entitlement_snapshots", "enterprise_contracts", "billing_invoices", "billing_promotions",
	...
	"system_feature_flags", "test_seed_runs", "fake_provider_tasks", "smoke_test_runs", "smoke_test_steps",
}
...
var softDeleteUniqueConstraintPolicies = map[string]string{
	...
	"recharge_packages":             "status_governed_identity",
	"recharge_orders":               "financial_idempotency",
	"mock_payment_transactions":     "financial_idempotency",
	"billing_package_skus":          "immutable_price_identity",
	"package_entitlement_snapshots": "entitlement_snapshot_identity",
	"enterprise_contracts":          "enterprise_contract_identity",
	"billing_invoices":              "financial_invoice_identity",
	"billing_promotions":            "status_governed_identity",
	...
	"system_feature_flags":          "status_governed_identity",
	"test_seed_runs":                "idempotency_replay",
	"fake_provider_tasks":           "idempotency_replay",
	"smoke_test_runs":               "idempotency_replay",
	"smoke_test_steps":              "idempotency_replay",
}
...
func TestBusinessSchemaBaselineWhitelistsMutableAndAppendOnlyTables(t *testing.T) {
	...
	if len(commonColumnBusinessTables) != 66 {
...
func TestSoftDeleteUniqueConstraintsHaveExplicitReusePolicy(t *testing.T) {
	...
	if len(softDeleteUniqueConstraintPolicies) != 62 {
