...
type PR3CreditHoldRecord struct {
...
func (PR3CreditHoldRecord) TableName() string { return "credit_holds" }

type PR3CreditLedgerEntryRecord struct {
...
func (PR3CreditLedgerEntryRecord) TableName() string { return "credit_ledger_entries" }

type PR3ToolPricingSnapshotRecord struct {
...
func (PR3ToolPricingSnapshotRecord) TableName() string { return "tool_pricing_snapshots" }

type PR3GeneratedAssetRecord struct {
...
func (PR3GeneratedAssetRecord) TableName() string { return "generated_assets" }

type PR3AssetCommitRecord struct {
...
func (PR3AssetCommitRecord) TableName() string { return "asset_commit_records" }
