...
- Fixtures：business-api fixture 覆盖 M5 success、permission、business error、idempotency conflict、timeout、version compatibility 场景；`scripts/validate-m5.sh` 已新增 fixture 字段语义门禁，防止 preview/confirm、通知 DTO 和 navigation 目标字段再次漂移。
