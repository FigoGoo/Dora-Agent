...
func approvalExpectedItemsV1() map[string]approvalExpectedItemV1 {
	...
	result := map[string]approvalExpectedItemV1{
		...
		"TC-P05": {
			...
			RequiredTests: []approvalRequiredTestV1{
				required("agent", "agent/tests/contract/w2r01/tool_receipt_v1_corpus_test.go", "TestToolReceiptV1Corpus", "normal"),
		...
		"TC-P07": {
			Title: "Access/Approval", OwnerRoles: []string{"business.authorization", "agent.access_snapshot", "agent.approval_store", "product", "frontend", "security", "finance", "testing"},
			ArtifactRefs: []approvalArtifactRefV1{
				artifact("agent/tests/contract/testdata/w2_r01/manifest.json", "corpus_manifest"),
				artifact("agent/tests/contract/testdata/w2_r02_turn_context/manifest.json", "corpus_manifest"),
			...
			RequiredTests: []approvalRequiredTestV1{
				...
				required("agent", "agent/tests/contract/w2r04approvalconsumption/approval_consumption_receipt_v1_corpus_test.go", "TestW2R04ApprovalConsumptionManifest", "normal"),
				required("agent", "agent/tests/contract/w2r04approvalconsumption/approval_consumption_receipt_v1_corpus_test.go", "TestApprovalConsumptionReceiptCoreV1Corpus", "normal"),
				required("agent", "agent/tests/contract/w2r04approvalconsumption/approval_consumption_receipt_v1_corpus_test.go", "TestApprovalConsumptionReceiptCoreV1ReplayAndQuery", "normal"),
				required("agent", "agent/tests/contract/w2r04approvalconsumption/approval_consumption_receipt_v1_corpus_test.go", "TestApprovalConsumptionReceiptCoreV1SingleUseConflicts", "normal"),
