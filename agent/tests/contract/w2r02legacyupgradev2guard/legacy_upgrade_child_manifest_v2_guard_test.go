// Package w2r02legacyupgradev2guard_test 独立守卫 R02 legacy-upgrade v2 child manifest 的来源与权限边界。
package w2r02legacyupgradev2guard_test
...
// TestW2R02LegacyUpgradeChildManifestGuardV2 独立校验 v2 manifest 的原始来源绑定与完整集合。
func TestW2R02LegacyUpgradeChildManifestGuardV2(t *testing.T) {
	t.Parallel()
...
// TestW2R02LegacyUpgradeChildManifestGuardV2StrictJSON 独立证明非严格 JSON 不能进入 prepared child manifest。
func TestW2R02LegacyUpgradeChildManifestGuardV2StrictJSON(t *testing.T) {
	t.Parallel()
...
// TestW2R02LegacyUpgradeChildManifestGuardV2SourceAndAuthorityMutations 拒绝来源集合、计数与权限状态越界。
func TestW2R02LegacyUpgradeChildManifestGuardV2SourceAndAuthorityMutations(t *testing.T) {
	t.Parallel()
