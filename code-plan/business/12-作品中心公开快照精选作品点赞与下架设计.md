...
| POST | `/api/works/:work_id/share/preview` | owner | `PreviewShareWorkRequest` | `ShareWorkPreviewDTO` | `blocked`、`confirming` |
| POST | `/api/works/:work_id/share/confirm` | owner | `ConfirmShareWorkRequest` + `Idempotency-Key` | `WorkShareResultDTO` | `shared` |
