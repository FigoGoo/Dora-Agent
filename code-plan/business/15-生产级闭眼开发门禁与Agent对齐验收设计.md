...
当前文档已随第一阶段服务端开发完成而归档。上表中的 Thrift IDL、HTTP OpenAPI、fixture、SQL、配置和测试报告仅用于追溯历史实现落点；后续新迭代以当前 active 契约、技术设计和测试文档为准。
...
| B13 服务级验收 | `tests/e2e`、`tests/contract`、测试报告 | 14、15、`code-plan/tests/00` | 主链路、跨服务、RPC、HTTP API、AG-UI、DB、日志验证报告；不含前端 UI 和部署上线 | `go test ./tests/contract/... ./tests/business/...`，服务级 E2E 按测试与验收脚本 |
